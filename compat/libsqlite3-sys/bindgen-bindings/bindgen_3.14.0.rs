...
// ---------------------------------------------------------------------------
// rustqlite supplement
//
// The upstream prebuilt bindings above were generated from a minimal
// sqlite3.h configuration. Modern consumers (sqlx 0.9) reference these
// newer (SQLite >= 3.20 / >= 3.36) API entry points, added here by hand
// with the exact sqlite3.h signatures. They are implemented by the
// rustqlite-compat library this crate links.
// ---------------------------------------------------------------------------
...
pub const SQLITE_DESERIALIZE_READONLY: ::std::os::raw::c_uint = 2;
pub const SQLITE_DESERIALIZE_RESIZEABLE: ::std::os::raw::c_uint = 4;
