...
> **Status**: production-ready core. **1150+ tests** (1155 in the default matrix
...
([sqlite.org/testing.html](https://www.sqlite.org/testing.html)); 1155 tests in
the default matrix (243 unit + 912 integration across 73 files), plus 65 C ABI
