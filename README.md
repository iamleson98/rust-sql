...
> **Status** (all numbers from the latest CI-green run [36100577250](https://github.com/iamleson98/rust-sql/actions/runs/36100577250) @ `c9dbc9c`, 2026-09-25, 31/31 jobs):
