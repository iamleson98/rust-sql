...
> **Status** (all numbers from the latest CI-green run [36159305309](https://github.com/iamleson98/rust-sql/actions/runs/36159305309) @ `bd4437a`, 2026-09-25, 31/31 jobs):
