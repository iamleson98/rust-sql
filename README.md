...
> **Status**: production-ready core. **1200+ tests** (1201 in the default matrix
...
([sqlite.org/testing.html](https://www.sqlite.org/testing.html)); 1201 tests in
the default matrix (254 unit + 947 integration across 75 files), plus 65 C ABI
